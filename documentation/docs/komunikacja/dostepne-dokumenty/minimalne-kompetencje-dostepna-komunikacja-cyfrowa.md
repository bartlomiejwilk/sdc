---
id: minimalne-kompetencje-dostepna-komunikacja-cyfrowa
title: Minimalne kompetencje w zakresie dostępnej komunikacji cyfrowej
description: Załącznik określający minimalne kompetencje pracowników uczestniczących w procesach komunikacji cyfrowej i publikacji treści.
sidebar_label: Minimalne kompetencje
sidebar_position: 12
keywords: [kompetencje,komunikacja cyfrowa,publikacja treści,dostępność cyfrowa,role,szkolenia,]
tags: [kompetencje,komunikacja cyfrowa,publikacja treści,dostępność cyfrowa,role,szkolenia,]
...
|---|---|
| Autor komunikatów | podstawowy |
| Redaktor treści | operacyjny |
| Osoba publikująca w CMS/BIP | operacyjny |
| Administrator publikacji | operacyjny |
| Specjalista ds. komunikacji | operacyjny |
| Koordynator dostępności | ekspercki |
| Osoba projektująca standardy | ekspercki |
| Grafik przygotowujący materiały | operacyjny |
| Osoba przygotowująca multimedia | operacyjny |
